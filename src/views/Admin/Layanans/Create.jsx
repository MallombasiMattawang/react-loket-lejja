...
export default function LayanansCreate() {
  //name page
  document.name = "Create Layanan";
  ...
  const storeLayanan = async (e) => {
    ...
    //sending data
    await Api.post("/api/admin/layanans", formData, {
      //header
      headers: {
        //header Bearer + Token
            ...
            <div className="col-md-12">
              ...
              <div className="card border-0 rounded shadow-sm border-top-success">
                <div className="card-body">
                  <h6>
                    <i className="fa fa-pencil-alt"></i> Create Layanan
                  </h6>
                  <hr />
